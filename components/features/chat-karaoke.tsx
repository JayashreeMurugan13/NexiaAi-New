        ...
        <div className="flex-1 flex flex-col h-full bg-zinc-950 p-4 md:p-8 overflow-y-auto">
            <div className="max-w-3xl mx-auto w-full">
                ...
                >
                    ...
                    >
                        <Music className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 text-green-400" />
                    </motion.div>
                    <h1 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-green-400 to-teal-400 bg-clip-text text-transparent mb-2">
                        Chat Karaoke
                    </h1>
                    <p className="text-sm md:text-base text-zinc-400">Transform your words into professional song lyrics</p>
                </motion.div>
                ...
                <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="relative">
                        <textarea
                            ...
                            rows={4}
                            className="w-full bg-zinc-900/50 border border-zinc-800 rounded-2xl py-3 md:py-4 px-4 md:px-6 text-sm md:text-base text-zinc-200 focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 resize-none"
                        />
                        <Button
                            onClick={generateLyrics}
                            disabled={loading}
                            className="absolute right-2 bottom-2 bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-500 hover:to-teal-500 p-2 md:p-3"
                        >
                    ...
                    <AnimatePresence>
                        {lyrics && (
                            <motion.div
                                ...
                                className="bg-gradient-to-br from-green-900/20 to-teal-900/20 border border-green-500/30 rounded-2xl p-4 md:p-8 backdrop-blur-sm relative overflow-hidden"
                            >
                                <motion.div
                                    animate={{ 
                                        background: [
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-start gap-3 md:gap-4">
                                        <Music className="w-5 h-5 md:w-6 md:h-6 text-green-400 flex-shrink-0 mt-1" />
                                        <div className="flex-1">
                                            <p className="text-green-300 text-xs uppercase tracking-wider mb-2 font-bold">
                                                {genre} Song
                                            </p>
                                            <div className="text-zinc-200 text-base md:text-lg leading-relaxed whitespace-pre-wrap font-mono">
                                                {lyrics}
                                            </div>
                                        </div>
                                    </div>
